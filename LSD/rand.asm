...
;
#SECTION "rand_ram", WRAMX, BANK[1] {
wRandState: ds 4
}

; Modified version from https://codeberg.org/ISSOtm/gb-starter-kit/src/branch/master/src/lib/rand.inc
; Modified to preserve HL/DE and to be compatible with GB.HLA
